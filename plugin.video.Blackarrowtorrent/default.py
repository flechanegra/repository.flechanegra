...
base = "https://raw.githubusercontent.com/flechanegra/blackarrowtorrent/master/fonte%201%20torrent"
tam = len(base)
off =  base
...
def SKindex():
    addon_log("SKindex")
    getData(off,'')
    msg2 = "https://raw.githubusercontent.com/AlexBarros74/fabiotorrents/master/alarme"				
    msg = msg2 
